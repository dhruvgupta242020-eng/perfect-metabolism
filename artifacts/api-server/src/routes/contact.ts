...
router.post("/contact", async (req, res) => {
  ...
  const gmailUser = process.env["GMAIL_USER"] ?? "perfectmetabolism@gmail.com";
  ...
  const mailOptions = {
    from: `"Perfect Metabolism Website" <${gmailUser}>`,
  ...
  try {
    ...
    req.log.info({ name, phone }, "Consultation request email sent");
